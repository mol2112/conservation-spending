---
title: "Conservation Funding Post-Processing"
author: "Jay Schoen, Vijay Ramesh"
output: pdf_document
---
...
# Data Import
```{r}
dat <- read_csv("~/Columbia E3B/Conservation Group/Output V15.2/master_output_data_analysis_v15.csv")
```

# Fixing algorithm errors discovered post-validation
## All fixes have been checked to have 0 mis-classifications (will only improve accuracy)
```{r}
...
```{r}
# If classified as Aquarium/zoo, all other categories besides soc_just are 0
...
dat.1.multi <- dat.1
# write_csv(dat.1.multi, "~/Columbia E3B/Conservation Group/Output V15.2/master_output_data_analysis_v15_mutlicategories.csv")
```

# Multi-category Filtering
Rules for within category multi-classification filtering: 
1. Grants with >2 independent classfications to be "other" category
2. Grants with two independent classifications are classified as the joint classification
3. Any grants with shared independent and joint classifications are classified as the joint
...
# Export for EDA
```{r, eval=FALSE}
# write_csv(data.final, "~/Columbia E3B/Conservation Group/Output V15.2/master_output_data_analysis_v15_filtered.csv")
```
